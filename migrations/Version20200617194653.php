...
final class Version20200617194653 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, gender_id INT NOT NULL, coloc_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone_number INT NOT NULL, age INT NOT NULL, profession VARCHAR(255) NOT NULL, about LONGTEXT DEFAULT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_8D93D649708A0E0 (gender_id), UNIQUE INDEX UNIQ_8D93D649927F2F4F (coloc_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
